...
<html lang="de">
  ...
  <body>
    ...
    <div class="container">
      ...
      <h3>Kontaktdaten</h3>
        <pre>Markus Ritzmann</br>Neubrunn 745</br>8488 Turbenthal</pre>
        <pre><i class="fa fa-envelope" aria-hidden="true"></i> markus <i>(at)</i> dnszensur.ch</br><i class="fa fa-twitter" aria-hidden="true"></i> <a href="https://twitter.com/RitzmannMarkus" target="_blank">@RitzmannMarkus</a></pre>
      ...
      <h3>Quelle</h3>
        <p>Dieses Impressum wurde am 03.06.2017 mit dem Impressum-Generator <a href="http://www.bag.ch/impressum-generator" target="_blank">http://www.bag.ch/impressum-generator</a> der Firma Brunner Medien AG in Kriens erstellt. Die Brunner Medien AG in Kriens übernimmt keine Haftung.</p>
      <h3>Web Analytics</h3>
